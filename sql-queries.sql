...
1. Our CEO wants to increase inventory of the two most popular family categories. he following categories are considered family movies: Animation, Children, Classics, Comedy, Family and Music. Which two categories have the most rentals? Create a query that lists each movie, the film category it is classified in, and the number of times it has been rented out.*/
...
/*
2. Provide a table with the family-friendly film category, each of the quartiles, and the corresponding count of movies within each combination of film category for each corresponding rental duration category. The resulting table should have three columns:
...
/*
3. We want to find out how the two stores compare in their count of rental orders during every month for all the years we have data for. Write a query that returns the store ID for the store, the year and month and the number of rental orders each store has fulfilled for that month. Your table should include a column for each of the following: year, month, store ID and count of rental orders fulfilled during that month.
*/
...
/*
4. To try to regain our top prior customers who are no longer active, we have been asked to generate a table of inactive customers that fall into the top half in terms of the amount of payments they have made. Columns include, customer name, amount spent, and if they fall into the top half of inactive customers.
*/
